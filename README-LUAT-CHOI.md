...
Trận đấu chạy 15 phút và được chia thành 4 giai đoạn.
...
- Bốn cứ điểm trở thành vị trí chiến lược để người chơi tích lũy thêm điểm.
...
### Giai đoạn 4: 12-15 phút - Độc quyền nhà nước

- Nhà nước áp dụng các rule điều tiết và giám sát độc quyền.
...
Trên bản đồ có 4 cứ điểm chiến lược:
...
Người chơi đứng liên tục trong vùng chiếm 5 giây để giành quyền kiểm soát.

Khi kiểm soát cứ điểm:

- Người chơi nhận 50 điểm khi chiếm hoặc cướp thành công, đây là mốc thưởng 1.
- Cứ mỗi 10 giây sở hữu liên tục, mức thưởng tăng thêm 50 điểm: mốc 2 nhận 100, mốc 3 nhận 150, ... mốc 15 nhận 750 điểm.
- Khi cứ điểm đổi chủ, cấp thưởng reset về mốc 1 cho chủ mới.
- Cứ điểm đổi sang màu của người sở hữu.
- Dashboard host và HUD player hiện tên người sở hữu.
- Đối thủ có thể đứng trong vùng 5 giây để cướp lại.
...
- `public/game-sprites.js`: load sprite, vẽ logo, resource và buffer nội suy vị trí.
